 ...
 #    
    ...
    async def bot_initiated_script(self):
        ...
        self.call_log.memory_exercise_reply = await self.ask("Now repeat as many of these words as you remember and say continue when you are done. Please begin after the beep.",
                               file="sounds/beep.wav", wait_time=30,  stopword_list=['continue'])
        ...
        self.call_log.l_reply = await self.ask("You have thirty seconds. Please begin after the beep.", file="sounds/beep.wav", wait_time=30, stopword_list=['continue'])
        ...
        self.call_log.animal_reply = await self.ask("You have thirty seconds. Please begin after the beep.", file="sounds/beep.wav", wait_time=30, stopword_list=['continue'])
        ...
        self.call_log.memory_exercise_reply_2 = await self.ask("You have thirty seconds. Please begin after the beep.", file="sounds/beep.wav", wait_time=30, stopword_list=['continue'])
    ...
    async def short_initiated_script(self):
        ...
        self.call_log.memory_exercise_reply = await self.ask("Please begin after the beep and say continue when you are done.", file="sounds/beep.wav",
        ...
        self.call_log.l_reply = await self.ask("Okay. Your letter is the letter L, as in love. You have thirty seconds. Please begin after the beep.", file="sounds/beep.wav", wait_time=30, stopword_list=['continue'])
        self.grading_tasks.append(asyncio.ensure_future(self.l_grade()))

        #animal naming word list task
        await self.ask_permission("Thank you. Now, I will give you a category. Are you ready?")
        self.call_log.animal_reply = await self.ask("Okay, your category is animals, you have thirty seconds. Please begin after the beep.", file="sounds/beep.wav", wait_time=30, stopword_list=['continue'])
        self.grading_tasks.append(asyncio.ensure_future(self.animal_grade()))

        #word list recall round 2
        self.call_log.memory_exercise_reply_2 = await self.ask("Thank you. Almost done. Try to recall as many of the six words I asked you to remember before. You have thirty seconds. Please begin after the beep.", file="sounds/beep.wav", wait_time=30, stopword_list=['continue'])
        self.grading_tasks.append(asyncio.ensure_future(self.memory_grade_2()))
        self.call_log.rejected = "completed"
        #goodbye
